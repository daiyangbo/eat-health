...
```yaml
# 模型配置
model_name_or_path: ./models/base/qwen2.5-1.5b  # 模型路径

# 数据配置
dataset_dir: ./data/processed  # 数据目录
dataset: train_llama  # 数据集名称
template: qwen  # 模板类型
finetuning_type: full  # 微调类型（全参数微调）
...
3. 查看 Qwen2.5 模型文档：https://huggingface.co/Qwen/Qwen2.5-1.5B
